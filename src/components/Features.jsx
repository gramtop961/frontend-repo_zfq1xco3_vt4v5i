    ...
    <section id="features" className="relative bg-slate-950 py-20 text-white">
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {features.map((f) => (
            <div key={f.title} className="group rounded-2xl border border-white/10 bg-white/5 p-6 transition hover:translate-y-[-2px] hover:border-indigo-400/40 hover:bg-white/10">
