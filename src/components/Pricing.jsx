          ...
          {tiers.map((t) => (
            ...
            >
              <div className="flex items-baseline justify-between">
                ...
                {t.highlight && (
                  <span className="rounded-full bg-yellow-400/20 px-2 py-1 text-xs text-yellow-200">Most popular</span>
                )}
              </div>
              <div className="mt-4 flex items-end gap-2">
                <div className="text-4xl font-bold text-yellow-300">{t.price}</div>
              ...
              <a
                href="#contact"
                className={`mt-8 inline-flex w-full items-center justify-center rounded-lg px-4 py-3 text-sm font-medium transition focus:outline-none focus:ring-2 focus:ring-yellow-300 ${
                  t.highlight
